    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-bell-o"></i>Teaching Staff</h1>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <div class="card-footer">
                      <button class="btn btn-success icon-btn" type="submit" name="sub" value="teaching_staff"><i class="fa fa-fw fa-lg fa-check-circle"></i> Submit</button>
                   </div>
                </form>
              </div>
            </div>
          ...
          if($_POST[sub]=="delete")
           {
             ...
             $upd_del="delete from `teaching_staff` where `id`='$_POST[hid]'";
           ...
           $sf=mysqli_query($con,"update `teaching_staff` set `name`='$name',`father`='$father',`qualifi`='$qualifi',`designa`='$designa',`mobile`='$mobile' where `id`='$_POST[hid]'");
           if($sf) {
              echo ("<script language='javascript'>
          ...
          <div class="col-sm-offset-0 col-md-12">
            <div class="card table-responsive">
              <h3 class="card-title">Teaching Staff List</h3>
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php
                  $notice_qry=mysqli_query($con,"select * from `teaching_staff` order by id desc");
