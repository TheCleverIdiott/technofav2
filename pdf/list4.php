...
$this->cell(30,10,"Due Payment",1,1,"C",true);
$i=1;
$amount=0;
$total=0;
$adv=0;
...
while($row=mysql_fetch_array($result))
{
	...
	while($row69=mysql_fetch_array($query69))
	{
	 ...
	 $sql23="select distinct invoice_date,invoice_no,grand_total from `product_in` where `purchase_by` ='".$row['name']."'";  
...
$this->CellFitScale(40,10,' '.$row['creditors_id'],'TLRB',0,"C");
