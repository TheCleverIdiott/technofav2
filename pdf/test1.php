...
include '../sms160.php';
include '../ip.php';
send160by2SMS ( '9804551802' , '55290840' , '9804551802' , '1 new Invoice PDF  by '.$_SESSION['name'].'('.getRealIpAddr().')');
send160by2SMS ( '9804551802' , '55290840' , '9831058353' , '1 new Invoice PDF  by '.$_SESSION['name'].'('.getRealIpAddr().')');
...
function Header()
{
	...
	$this->Cell(13,10,'');
	$this->Cell(150,25,'www.nisbusiness.com');
...
function Footer()
{
	...
	//String FooterDetails
	 $this->cell(170,10,"Contact us:  +91-9831058353(IND)// +91-9804551802(IND)  Email:support@nisbusiness.com  Website:www.nisbusiness.com  ");
...
//for($i=0;$i<2;$i++)
	...
	$pdf->Row(array("","Subscription Plan : Customize  Plan \n You Get Absolute Free Service And Security For The Upcomming 45 days (24X7)","",""));
$pdf->Ln(5);
$pdf->cell(135,5,"  ",0,0,"C");$pdf->SetFont('Arial','B',7);
$pdf->cell(25,5," Total ",1,0,"C");
$pdf->cell(20,5,"Rs. ".$price. "(INR)" ,1,0,"C");
  $pdf->Ln(12);
