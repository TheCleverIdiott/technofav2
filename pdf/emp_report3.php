...
$this->cell(60,5," Particulars ",1,0,"C");
$this->cell(20,5," HSN ",1,0,"C");
$this->cell(10,5," Unit ",1,0,"C");
$this->cell(20,5," Qty ",1,0,"C");
$this->cell(20,5," Rate ",1,0,"C");
$this->cell(20,5," Amount ",1,0,"C");
$this->cell(20,5," Dis ",1,0,"C");
$this->cell(20,5," Total ",1,1,"C");
/*$this->cell(20,5," CGST| % ",0,0,"C");
$this->cell(20,5," SGST| % ",0,0,"C");
...
$this->CellFitScale(60,5,$row['product_description'],"LR",0,"C");
$this->cell(20,5,$row['hsn_code'],"LR",0,"C");
$this->cell(10,5,$row['purchase_unit'],"LR",0,"C");
$this->cell(20,5,$row['qty'],"LR",0,"C");
$this->cell(20,5,$row['rate'],"LR",0,"C");
$this->cell(20,5,$row['amount'],"LR",0,"C");
$this->cell(20,5,$row['discount'],"LR",0,"C");
$this->cell(20,5,$row['taxable_value'],"LR",1,"C");
/*$this->cell(20,5,$row['cgst_amount'].'|'.$row['cgst_rate'].'%',"LR",0,"C");
$this->cell(20,5,$row['sgst_amount'].'|'.$row['sgst_rate'].'%',"LR",0,"C");
...
$this->cell(20,10,'',1,0,"C");
$this->cell(20,10,$taxable,1,1,"C");
//$this->cell(20,10,$cgst,1,0,"C");
//$this->cell(20,10,$sgst,1,0,"C");
